...
import juhe.JHTempBean;

public class CityManagerAdapter extends BaseAdapter{
    Context context;
    List<db.DatabaseBean>mDatas;

    public CityManagerAdapter(Context context, List<db.DatabaseBean> mDatas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        db.DatabaseBean bean = mDatas.get(position);
