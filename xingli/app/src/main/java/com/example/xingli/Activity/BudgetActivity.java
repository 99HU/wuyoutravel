...
public class BudgetActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        builder.setTitle("提示信息").setMessage("您确定要删除这条记录么？")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //执行删除的操作
                        DBMangerBudget.deleteItemFromAccounttbById(click_id);
    ...
    private void setTopTvShow() {
        ...
        float incomeOneDay = DBMangerBudget.getSumMoneyOneDay(year, month, day, 1);
        float outcomeOneDay = DBMangerBudget.getSumMoneyOneDay(year, month, day, 0);
        String infoOneDay = "今日支出 ￥"+outcomeOneDay+"  收入 ￥"+incomeOneDay;
        topConTv.setText(infoOneDay);
//        获取本月收入和支出总金额
        float incomeOneMonth = DBMangerBudget.getSumMoneyOneMonth(year, month, 1);
        float outcomeOneMonth = DBMangerBudget.getSumMoneyOneMonth(year, month, 0);
...
//    设置显示运算剩余
    ...
    private void loadDBData() {
        List<AccountBean> list = DBMangerBudget.getAccountListOneDayFromAccounttb(year, month, day);
        mDatas.clear();
        mDatas.addAll(list);
