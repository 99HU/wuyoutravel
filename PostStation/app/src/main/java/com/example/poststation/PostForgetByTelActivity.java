...
public class PostForgetByTelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_forget_by_tel);

        managerName = (EditText) findViewById(R.id.managername);
        managerTel = (EditText) findViewById(R.id.manager_tel);
        ...
        sendCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                s_managerTel = managerTel.getText().toString();
                ...
                if (s_managerName.isEmpty()) {
                    ...
                    bmobQueryName.findObjects(new FindListener<Manager>() {
                        ...
                        public void done(List<Manager> list, BmobException e) {
                            ...
                            //此处为需要留下的代码
                            BmobSMS.requestSMSCode(s_managerTel, "", new QueryListener<Integer>() {
                                @Override
                                public void done(Integer smsId, BmobException e) {
                                    if (e == null) {
                                        Toast.makeText(PostForgetByTelActivity.this, "发送验证码成功，短信ID：" + smsId + "\n", Toast.LENGTH_SHORT).show();
                                    } else {
                                        Toast.makeText(PostForgetByTelActivity.this, "发送验证码失败：" + e.getErrorCode() + "-" + e.getMessage() + "\n", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BmobUser.resetPasswordBySMSCode(s_code, s_newPassword, new UpdateListener() {
                    ...
                    public void done(BmobException e) {
                        if (e == null) {
                            Toast.makeText(PostForgetByTelActivity.this, "重置成功", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(PostForgetByTelActivity.this, "重置失败：" + e.getErrorCode() + "-" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
