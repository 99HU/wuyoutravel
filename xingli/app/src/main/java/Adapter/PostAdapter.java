...
public class PostAdapter extends ArrayAdapter<Post> implements Filterable {
    ...
    public ArrayList<Post> mOriginalValues;
    private final Object mLock = new Object();


    public PostAdapter(Context context, int textViewRouseId, List<Post> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.postPrice = (TextView) view.findViewById(R.id.post_price);
            viewHolder.postOrderNum = (TextView) view.findViewById(R.id.post_ordernum);
        ...
        viewHolder.postPrice.setText("行李箱类￥"+String.valueOf(post.getLargePrice())+"/件/天\n" +"小包类￥"+String.valueOf(post.getSmallPrice())+"元/件/天");
        viewHolder.postOrderNum.setText("月售量" + String.valueOf(post.getPostOrderNum()));
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    ||value.getPostProfile().contains(prefixString)||value.getPostTel().contains(prefixString)) {
