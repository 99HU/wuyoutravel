...
class Post extends BmobObject {
    ...
    public Post(String postName, int postId, int postImageId, String postTel, String postLoc, String postProfile, int postOrderNum, double largePrice, double smallPrice, String postNotice1, String postNotice2, String postNotice3, String postHolderSay, String postOpenTime, int largerNum, int smallNum) {
        PostName = postName;
