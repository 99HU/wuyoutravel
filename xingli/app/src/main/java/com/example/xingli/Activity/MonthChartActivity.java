...
//        将Fragment加载到Acitivy当中
    ...
    private void initStatistics(int year, int month) {
        float inMoneyOneMonth = DBMangerBudget.getSumMoneyOneMonth(year, month, 1);  //收入总钱数
        float outMoneyOneMonth = DBMangerBudget.getSumMoneyOneMonth(year, month, 0); //支出总钱数
        int incountItemOneMonth = DBMangerBudget.getCountItemOneMonth(year, month, 1);  //收入多少笔
        int outcountItemOneMonth = DBMangerBudget.getCountItemOneMonth(year, month, 0); //支出多少笔
