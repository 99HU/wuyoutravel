...
public class Order extends BmobObject implements Serializable {
    ...
    public static String GuideTask="负责带领顾客游玩一天";
...
//    }
    ...
    public void setGuide(db.Guide guide) {
        this.guide = guide;
    }
...
//    }
    ...
    public db.Post getStartPost() {
        return startPost;
    }

    public void setStartPost(db.Post startPost) {
        this.startPost = startPost;
    }

    public db.Post getEndPost() {
        return endPost;
    }

    public void setEndPost(db.Post endPost) {
        this.endPost = endPost;
    }
