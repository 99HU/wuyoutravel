...
public class MainActivity extends AppCompatActivity {
        ...
        public void onClick(DialogInterface dialog, int which)
        {
            switch (which)
            {
                case AlertDialog.BUTTON_POSITIVE:// "确认"按钮退出程序
                    Intent intent = new Intent(MainActivity.this, PhotographerForgetByTel.class);
                    startActivity(intent);
                    break;
                case AlertDialog.BUTTON_NEGATIVE:// "取消"第二个按钮取消对话框
                    Intent intent1 = new Intent(MainActivity.this, PhotographerForgetByEmail.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (s_account.isEmpty() || s_passWord.isEmpty()) {
                    ...
                    BmobQuery<Photographer> userBmobQuery = new BmobQuery<>();
                    userBmobQuery.addWhereEqualTo("username", s_account);
                    userBmobQuery.findObjects(new FindListener<Photographer>() {
                        @Override
                        public void done(List<Photographer> list, BmobException e) {
                            if (list.size() != 0) {
                                final Photographer photographer = new Photographer(s_account, s_passWord);
                                photographer.login(new SaveListener<Photographer>() {
                                    @Override
                                    public void done(Photographer bmobPostStation, BmobException e) {
                                        if (e == null) {
                                            //账号密码正确，复选框操作
                                            editor = pref.edit();
                                            ...
                                            Intent intent = new Intent(MainActivity.this, PhotographerHomePage.class);
                                            startActivity(intent);
                                        } else {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, PhotographerRegister.class);
                startActivity(intent);
            }
        });
